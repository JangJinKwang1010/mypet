		...
		<div class="mainbox">
			...
			<form autocomplete="off"  id="form">
				<div class ="mainbox2 freebox">
					...
					<input type="text" class="writing_title form-control" name="ftitle" value="${vo.ftitle }">
					<textarea class="writing_content form-control" name="fcontent">${vo.fcontent }</textarea>
