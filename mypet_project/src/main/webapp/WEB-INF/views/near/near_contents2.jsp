	...
	<section class="section">
		<div class="mainbox">
			...
			<div class ="mainbox2 freebox">
				...
				<p class="post_title"><span class="logo">${vo.kind }</span>${vo.title }</p>
				<p class="name">${vo.id }</p>
				<div class="post_line"></div>
				<p class="post_date">${vo.ndate }</p>
			...
			<div class="button">
				...
				<button type="button" class="update" onclick="location.href='near_update2.do?nid=${vo.nid2}' ">수정</button>
